...
public class VipManagerActivity extends FragmentActivity {
    //views
    private RecyclerView mListRv;
    private ImageView ivRight, ivSearch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivTitle.setText("会员管理");
        ivRight.setVisibility(View.VISIBLE);
        ivSearch.setVisibility(View.VISIBLE);
        mListRv = findViewById(R.id.rv_list);
        mListRv.setLayoutManager(new LinearLayoutManager(VipManagerActivity.this));
        ...
        mDatas.add(R.mipmap.ic_launcher);
        mDatas.add(R.mipmap.ic_launcher);
        mAdapter = new BaseRecyclerViewAdapter<Integer>(this, R.layout.item_vip_manager) {
            @Override
